      ...
      <div className="container">
        <div className="row mb-5 align-items-center">
          <div className="col-md-12 col-lg-12 mb-4 mb-lg-0">
            <h2 className="mb-4">Week Planner</h2>
            <div>
              <div className="mb-4 text-center">
                <p className="lead">
                  Generate a personalized week with random tips to help you practice self-care.
                </p>
                <button className="btn btn-primary btn-lg me-2" onClick={() => generateRandomTips(1)}>
                  <i className="bi bi-shuffle"></i> Feeling Lucky - Day Planner
                </button>

                <button className="btn btn-primary btn-lg" onClick={() => generateRandomTips(6)}>
                  <i className="bi bi-shuffle"></i> Feeling Lucky - Week Planner
                </button>

                {generatedUrl && (
                  <div className="mt-3">
                    <p className="mb-2">Your personalized planner is ready:</p>
                    <a href={generatedUrl} className="btn btn-success btn-lg">
                      <i className="bi bi-calendar-week"></i> Open My Planner
                    </a>
                    <div className="mt-2">
                      <small className="text-muted">Or copy this link: </small>
                      <input
                        type="text"
